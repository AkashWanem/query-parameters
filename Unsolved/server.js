...
// GET: /api/terms - returns terms data as json object

app.get('/api/terms/', (req, res) => {
  // TODO: Add a comment describing the req.query object
  // req.query object is all the query variables, object keys is all the keys in the object
